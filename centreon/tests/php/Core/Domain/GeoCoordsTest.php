...
it(
    'should return a valid geo coord object for valid latitudes',
...
it(
    'should return a valid geo coord object for valid longitudes',
...
it(
    'should not return a valid geo coord object for invalid latitudes',
    function (): void {
...
it(
    'should not return a valid geo coord object for invalid longitudes',
    function (): void {
...
it(
    'should throw an exception when geo coords has too few coordinates',
...
it(
    'should throw an exception when geo coords has too much coordinates',
...
it(
    'should throw an exception when geo coords has wrong values but a valid format',
    fn() => GeoCoords::fromString(',')
)->throws(
...
it(
    'should throw an exception when geo coords has wrong latitude',
...
it(
    'should throw an exception when geo coords has wrong longitude',
